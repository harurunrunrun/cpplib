#ifndef CPPLIB_SRC_ALGORITHM_TREE_QUERY_TREE_PATH_MINMAX_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_TREE_QUERY_TREE_PATH_MINMAX_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_TREE_QUERY_TREE_PATH_MINMAX_HPP_INCLUDED
