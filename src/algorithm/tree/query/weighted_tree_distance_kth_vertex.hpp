#ifndef CPPLIB_SRC_ALGORITHM_TREE_QUERY_WEIGHTED_TREE_DISTANCE_KTH_VERTEX_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_TREE_QUERY_WEIGHTED_TREE_DISTANCE_KTH_VERTEX_HPP_INCLUDED
