#ifndef CPPLIB_SRC_ALGORITHM_TREE_QUERY_LCA_SUBTREE_DISTINCT_COLORS_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_TREE_QUERY_LCA_SUBTREE_DISTINCT_COLORS_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_TREE_QUERY_LCA_SUBTREE_DISTINCT_COLORS_HPP_INCLUDED
