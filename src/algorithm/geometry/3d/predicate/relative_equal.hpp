#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_PREDICATE_RELATIVE_EQUAL_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_PREDICATE_RELATIVE_EQUAL_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_PREDICATE_RELATIVE_EQUAL_HPP_INCLUDED
