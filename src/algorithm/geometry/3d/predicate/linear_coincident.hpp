#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_PREDICATE_LINEAR_COINCIDENT_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_PREDICATE_LINEAR_COINCIDENT_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_PREDICATE_LINEAR_COINCIDENT_HPP_INCLUDED
