#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_POINT_POINT_UNIT_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_POINT_POINT_UNIT_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_POINT_POINT_UNIT_HPP_INCLUDED
