#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_POINT_CIRCLE_CLOSEST_POINT_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_POINT_CIRCLE_CLOSEST_POINT_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_POINT_CIRCLE_CLOSEST_POINT_HPP_INCLUDED
