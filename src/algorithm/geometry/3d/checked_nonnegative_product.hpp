#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_CHECKED_NONNEGATIVE_PRODUCT_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_CHECKED_NONNEGATIVE_PRODUCT_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_CHECKED_NONNEGATIVE_PRODUCT_HPP_INCLUDED
