#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_QUERY_LINE_RAY_INTERSECTION_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_QUERY_LINE_RAY_INTERSECTION_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_QUERY_LINE_RAY_INTERSECTION_HPP_INCLUDED
