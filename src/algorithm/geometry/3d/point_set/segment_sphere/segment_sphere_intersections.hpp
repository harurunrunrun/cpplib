#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_POINT_SET_SEGMENT_SPHERE_SEGMENT_SPHERE_INTERSECTIONS_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_POINT_SET_SEGMENT_SPHERE_SEGMENT_SPHERE_INTERSECTIONS_HPP_INCLUDED
...
#include "../line_sphere/line_sphere_intersections.hpp"
...
inline std::vector<Point3> segment_sphere_intersections(
    ...
    if(!geometry3d_is_finite(segment))[[unlikely]]{
        throw std::invalid_argument(
            "segment-sphere intersection requires a finite segment"
        );
    }
    if(segment.a.x == segment.b.x && segment.a.y == segment.b.y &&
        segment.a.z == segment.b.z){
        return on_sphere(sphere, segment.a)
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_POINT_SET_SEGMENT_SPHERE_SEGMENT_SPHERE_INTERSECTIONS_HPP_INCLUDED
