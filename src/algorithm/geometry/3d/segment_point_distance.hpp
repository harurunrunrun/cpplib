#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_SEGMENT_POINT_DISTANCE_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_SEGMENT_POINT_DISTANCE_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_3D_SEGMENT_POINT_DISTANCE_HPP_INCLUDED
