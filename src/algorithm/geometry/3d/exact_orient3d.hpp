...
inline int sign(const boost::multiprecision::cpp_int& value){
...
inline int orient3d_cpp_int(
    ...
    for(std::size_t coordinate = 0; coordinate < 3; ++coordinate){
        u[coordinate] = cpp_int(second[coordinate]) - first[coordinate];
        v[coordinate] = cpp_int(third[coordinate]) - first[coordinate];
        w[coordinate] = cpp_int(fourth[coordinate]) - first[coordinate];
    }
...
inline int exact_orient3d(
    ...
    return geometry3d_integer_predicate_detail::orient3d_cpp_int(
