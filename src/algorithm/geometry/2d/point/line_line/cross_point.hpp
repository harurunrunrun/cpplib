#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_POINT_LINE_LINE_CROSS_POINT_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_POINT_LINE_LINE_CROSS_POINT_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_POINT_LINE_LINE_CROSS_POINT_HPP_INCLUDED
