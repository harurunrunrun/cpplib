#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_RESULT_POINT_SET_VISIBILITY_GRAPH_POINTS_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_RESULT_POINT_SET_VISIBILITY_GRAPH_POINTS_HPP_INCLUDED
...
inline std::vector<DirectionGroup> direction_groups(
    ...
    if(1 < vertices.size()){
        ...
        std::rotate(
            vertices.begin(),
            vertices.begin() + static_cast<std::ptrdiff_t>(start),
            vertices.end()
        );
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_RESULT_POINT_SET_VISIBILITY_GRAPH_POINTS_HPP_INCLUDED
