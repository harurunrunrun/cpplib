#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_RESULT_POINT_SET_MINIMUM_ENCLOSING_RECTANGLE_NORMALIZED_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_RESULT_POINT_SET_MINIMUM_ENCLOSING_RECTANGLE_NORMALIZED_HPP_INCLUDED
...
#include "../../type/definition/minimum_enclosing_rectangle_result.hpp"
...
inline MinimumEnclosingRectangleResult minimum_enclosing_rectangle(
    ...
    const Point initial_axis = unit(vertices[1] - vertices[0]);
    const Point initial_normal = rotate90(initial_axis);
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_RESULT_POINT_SET_MINIMUM_ENCLOSING_RECTANGLE_NORMALIZED_HPP_INCLUDED
