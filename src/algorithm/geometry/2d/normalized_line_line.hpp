#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_NORMALIZED_LINE_LINE_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_NORMALIZED_LINE_LINE_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_NORMALIZED_LINE_LINE_HPP_INCLUDED
