#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_SCALAR_CIRCLE_ARC_LENGTH_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_SCALAR_CIRCLE_ARC_LENGTH_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_SCALAR_CIRCLE_ARC_LENGTH_HPP_INCLUDED
