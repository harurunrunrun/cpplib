#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_FURTHEST_PAIR_RESULT_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_FURTHEST_PAIR_RESULT_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_FURTHEST_PAIR_RESULT_HPP_INCLUDED
