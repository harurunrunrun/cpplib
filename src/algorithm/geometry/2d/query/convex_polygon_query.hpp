#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_QUERY_CONVEX_POLYGON_QUERY_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_QUERY_CONVEX_POLYGON_QUERY_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_QUERY_CONVEX_POLYGON_QUERY_HPP_INCLUDED
