#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_VOID_CIRCLE_VALIDATE_CIRCLE_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_VOID_CIRCLE_VALIDATE_CIRCLE_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_VOID_CIRCLE_VALIDATE_CIRCLE_HPP_INCLUDED
