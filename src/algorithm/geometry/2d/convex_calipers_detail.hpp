#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_CONVEX_CALIPERS_DETAIL_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_CONVEX_CALIPERS_DETAIL_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_CONVEX_CALIPERS_DETAIL_HPP_INCLUDED
