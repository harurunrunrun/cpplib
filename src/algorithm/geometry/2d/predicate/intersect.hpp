#ifndef CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_PREDICATE_INTERSECT_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_PREDICATE_INTERSECT_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GEOMETRY_2D_PREDICATE_INTERSECT_HPP_INCLUDED
