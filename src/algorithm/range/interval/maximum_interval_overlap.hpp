#ifndef CPPLIB_SRC_ALGORITHM_RANGE_INTERVAL_MAXIMUM_INTERVAL_OVERLAP_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_RANGE_INTERVAL_MAXIMUM_INTERVAL_OVERLAP_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_RANGE_INTERVAL_MAXIMUM_INTERVAL_OVERLAP_HPP_INCLUDED
