#ifndef CPPLIB_SRC_ALGORITHM_MATH_FAST_MATRIX_MULTIPLY_MOD_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_MATH_FAST_MATRIX_MULTIPLY_MOD_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_MATH_FAST_MATRIX_MULTIPLY_MOD_HPP_INCLUDED
