#ifndef CPPLIB_SRC_ALGORITHM_MATH_SEQUENCE_LINEAR_RECURRENCE_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_MATH_SEQUENCE_LINEAR_RECURRENCE_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_MATH_SEQUENCE_LINEAR_RECURRENCE_HPP_INCLUDED
