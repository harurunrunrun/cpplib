#ifndef CPPLIB_SRC_ALGORITHM_MATH_POLYNOMIAL_SUBSET_CONVOLUTION_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_MATH_POLYNOMIAL_SUBSET_CONVOLUTION_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_MATH_POLYNOMIAL_SUBSET_CONVOLUTION_HPP_INCLUDED
