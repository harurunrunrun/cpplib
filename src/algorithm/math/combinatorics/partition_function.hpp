#ifndef CPPLIB_SRC_ALGORITHM_MATH_COMBINATORICS_PARTITION_FUNCTION_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_MATH_COMBINATORICS_PARTITION_FUNCTION_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_MATH_COMBINATORICS_PARTITION_FUNCTION_HPP_INCLUDED
