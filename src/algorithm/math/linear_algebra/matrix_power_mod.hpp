#ifndef CPPLIB_SRC_ALGORITHM_MATH_LINEAR_ALGEBRA_MATRIX_POWER_MOD_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_MATH_LINEAR_ALGEBRA_MATRIX_POWER_MOD_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_MATH_LINEAR_ALGEBRA_MATRIX_POWER_MOD_HPP_INCLUDED
