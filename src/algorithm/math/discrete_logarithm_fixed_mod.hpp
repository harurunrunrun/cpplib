#ifndef CPPLIB_SRC_ALGORITHM_MATH_DISCRETE_LOGARITHM_FIXED_MOD_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_MATH_DISCRETE_LOGARITHM_FIXED_MOD_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_MATH_DISCRETE_LOGARITHM_FIXED_MOD_HPP_INCLUDED
