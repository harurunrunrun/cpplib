#ifndef CPPLIB_SRC_ALGORITHM_MATH_NUMBER_THEORY_MIN_OF_MOD_OF_LINEAR_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_MATH_NUMBER_THEORY_MIN_OF_MOD_OF_LINEAR_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_MATH_NUMBER_THEORY_MIN_OF_MOD_OF_LINEAR_HPP_INCLUDED
