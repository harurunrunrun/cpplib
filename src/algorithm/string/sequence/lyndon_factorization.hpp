#ifndef CPPLIB_SRC_ALGORITHM_STRING_SEQUENCE_LYNDON_FACTORIZATION_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_STRING_SEQUENCE_LYNDON_FACTORIZATION_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_STRING_SEQUENCE_LYNDON_FACTORIZATION_HPP_INCLUDED
