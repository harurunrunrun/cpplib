#ifndef CPPLIB_SRC_ALGORITHM_STRING_PALINDROME_MANACHER_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_STRING_PALINDROME_MANACHER_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_STRING_PALINDROME_MANACHER_HPP_INCLUDED
