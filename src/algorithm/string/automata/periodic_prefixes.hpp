#ifndef CPPLIB_SRC_ALGORITHM_STRING_AUTOMATA_PERIODIC_PREFIXES_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_STRING_AUTOMATA_PERIODIC_PREFIXES_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_STRING_AUTOMATA_PERIODIC_PREFIXES_HPP_INCLUDED
