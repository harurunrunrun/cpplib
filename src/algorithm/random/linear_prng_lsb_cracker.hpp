#ifndef CPPLIB_SRC_ALGORITHM_RANDOM_LINEAR_PRNG_LSB_CRACKER_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_RANDOM_LINEAR_PRNG_LSB_CRACKER_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_RANDOM_LINEAR_PRNG_LSB_CRACKER_HPP_INCLUDED
