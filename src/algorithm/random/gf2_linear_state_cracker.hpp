#ifndef CPPLIB_SRC_ALGORITHM_RANDOM_GF2_LINEAR_STATE_CRACKER_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_RANDOM_GF2_LINEAR_STATE_CRACKER_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_RANDOM_GF2_LINEAR_STATE_CRACKER_HPP_INCLUDED
