#ifndef CPPLIB_SRC_ALGORITHM_OTHER_SEQUENCE_INVERSION_COUNT_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_OTHER_SEQUENCE_INVERSION_COUNT_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_OTHER_SEQUENCE_INVERSION_COUNT_HPP_INCLUDED
