#ifndef CPPLIB_SRC_ALGORITHM_OTHER_UTILITY_SOURCE_ZIP_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_OTHER_UTILITY_SOURCE_ZIP_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_OTHER_UTILITY_SOURCE_ZIP_HPP_INCLUDED
