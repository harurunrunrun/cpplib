#ifndef CPPLIB_SRC_ALGORITHM_OTHER_OFFLINE_QUERY_MO_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_OTHER_OFFLINE_QUERY_MO_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_OTHER_OFFLINE_QUERY_MO_HPP_INCLUDED
