#ifndef CPPLIB_SRC_ALGORITHM_OTHER_DYNAMIC_RECTANGLE_ADD_POINT_GET_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_OTHER_DYNAMIC_RECTANGLE_ADD_POINT_GET_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_OTHER_DYNAMIC_RECTANGLE_ADD_POINT_GET_HPP_INCLUDED
