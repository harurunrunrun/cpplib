#ifndef CPPLIB_SRC_ALGORITHM_GRAPH_TRAVERSAL_EULERIAN_TRAIL_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GRAPH_TRAVERSAL_EULERIAN_TRAIL_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GRAPH_TRAVERSAL_EULERIAN_TRAIL_HPP_INCLUDED
