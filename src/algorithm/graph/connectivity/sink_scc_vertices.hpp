#ifndef CPPLIB_SRC_ALGORITHM_GRAPH_CONNECTIVITY_SINK_SCC_VERTICES_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GRAPH_CONNECTIVITY_SINK_SCC_VERTICES_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GRAPH_CONNECTIVITY_SINK_SCC_VERTICES_HPP_INCLUDED
