#ifndef CPPLIB_SRC_ALGORITHM_GRAPH_CONSTRAINTS_HORN_SAT_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GRAPH_CONSTRAINTS_HORN_SAT_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GRAPH_CONSTRAINTS_HORN_SAT_HPP_INCLUDED
