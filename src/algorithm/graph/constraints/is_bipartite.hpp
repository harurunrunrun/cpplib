#ifndef CPPLIB_SRC_ALGORITHM_GRAPH_CONSTRAINTS_IS_BIPARTITE_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GRAPH_CONSTRAINTS_IS_BIPARTITE_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GRAPH_CONSTRAINTS_IS_BIPARTITE_HPP_INCLUDED
