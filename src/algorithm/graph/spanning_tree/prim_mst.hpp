#ifndef CPPLIB_SRC_ALGORITHM_GRAPH_SPANNING_TREE_PRIM_MST_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GRAPH_SPANNING_TREE_PRIM_MST_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GRAPH_SPANNING_TREE_PRIM_MST_HPP_INCLUDED
