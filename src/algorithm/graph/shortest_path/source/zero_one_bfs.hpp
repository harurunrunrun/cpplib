#ifndef CPPLIB_SRC_ALGORITHM_GRAPH_SHORTEST_PATH_SOURCE_ZERO_ONE_BFS_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GRAPH_SHORTEST_PATH_SOURCE_ZERO_ONE_BFS_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GRAPH_SHORTEST_PATH_SOURCE_ZERO_ONE_BFS_HPP_INCLUDED
