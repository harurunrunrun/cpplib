#ifndef CPPLIB_SRC_ALGORITHM_GRAPH_SHORTEST_PATH_SOURCE_SPFA_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_GRAPH_SHORTEST_PATH_SOURCE_SPFA_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_GRAPH_SHORTEST_PATH_SOURCE_SPFA_HPP_INCLUDED
