#ifndef CPPLIB_SRC_ALGORITHM_FFT_BIVARIATE_FORMAL_POWER_SERIES_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_FFT_BIVARIATE_FORMAL_POWER_SERIES_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_FFT_BIVARIATE_FORMAL_POWER_SERIES_HPP_INCLUDED
