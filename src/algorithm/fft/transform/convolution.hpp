#ifndef CPPLIB_SRC_ALGORITHM_FFT_TRANSFORM_CONVOLUTION_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_FFT_TRANSFORM_CONVOLUTION_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_FFT_TRANSFORM_CONVOLUTION_HPP_INCLUDED
