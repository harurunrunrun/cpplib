#ifndef CPPLIB_SRC_ALGORITHM_MATCHING_FLOW_BURN_BURY_HPP_INCLUDED
#define CPPLIB_SRC_ALGORITHM_MATCHING_FLOW_BURN_BURY_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_ALGORITHM_MATCHING_FLOW_BURN_BURY_HPP_INCLUDED
