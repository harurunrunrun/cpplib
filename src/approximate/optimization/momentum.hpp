#ifndef CPPLIB_SRC_APPROXIMATE_OPTIMIZATION_MOMENTUM_HPP_INCLUDED
#define CPPLIB_SRC_APPROXIMATE_OPTIMIZATION_MOMENTUM_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_APPROXIMATE_OPTIMIZATION_MOMENTUM_HPP_INCLUDED
