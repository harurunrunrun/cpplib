#ifndef CPPLIB_SRC_STRUCTURE_TYPES_DICE_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_TYPES_DICE_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_TYPES_DICE_HPP_INCLUDED
