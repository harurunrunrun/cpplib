#ifndef CPPLIB_SRC_STRUCTURE_TYPES_MONOID_SUM_SQUARES_MONOID_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_TYPES_MONOID_SUM_SQUARES_MONOID_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_TYPES_MONOID_SUM_SQUARES_MONOID_HPP_INCLUDED
