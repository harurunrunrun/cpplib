#ifndef CPPLIB_SRC_STRUCTURE_TYPES_MONOID_COMMON_MONOIDS_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_TYPES_MONOID_COMMON_MONOIDS_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_TYPES_MONOID_COMMON_MONOIDS_HPP_INCLUDED
