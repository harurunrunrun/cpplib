#ifndef CPPLIB_SRC_STRUCTURE_TYPES_MONOID_MONOID_ACT_LEN_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_TYPES_MONOID_MONOID_ACT_LEN_HPP_INCLUDED
#include <type_traits>
...
#endif  // CPPLIB_SRC_STRUCTURE_TYPES_MONOID_MONOID_ACT_LEN_HPP_INCLUDED
