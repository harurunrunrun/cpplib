#ifndef CPPLIB_SRC_STRUCTURE_TREE_INTEGER_SET_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_TREE_INTEGER_SET_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_TREE_INTEGER_SET_HPP_INCLUDED
