#ifndef CPPLIB_SRC_STRUCTURE_TREE_LAZY_TOP_TREE_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_TREE_LAZY_TOP_TREE_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_TREE_LAZY_TOP_TREE_HPP_INCLUDED
