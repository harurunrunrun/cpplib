#ifndef CPPLIB_SRC_STRUCTURE_TREE_QUERY_ROOT_PATH_FIRST_MARKED_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_TREE_QUERY_ROOT_PATH_FIRST_MARKED_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_TREE_QUERY_ROOT_PATH_FIRST_MARKED_HPP_INCLUDED
