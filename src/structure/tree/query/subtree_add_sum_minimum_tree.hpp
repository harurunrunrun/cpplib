#ifndef CPPLIB_SRC_STRUCTURE_TREE_QUERY_SUBTREE_ADD_SUM_MINIMUM_TREE_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_TREE_QUERY_SUBTREE_ADD_SUM_MINIMUM_TREE_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_TREE_QUERY_SUBTREE_ADD_SUM_MINIMUM_TREE_HPP_INCLUDED
