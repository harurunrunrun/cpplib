#ifndef CPPLIB_SRC_STRUCTURE_TREE_QUERY_MONOCHROMATIC_COMPONENT_MAX_TREE_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_TREE_QUERY_MONOCHROMATIC_COMPONENT_MAX_TREE_HPP_INCLUDED
