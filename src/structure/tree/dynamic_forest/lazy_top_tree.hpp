#ifndef CPPLIB_SRC_STRUCTURE_TREE_DYNAMIC_FOREST_LAZY_TOP_TREE_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_TREE_DYNAMIC_FOREST_LAZY_TOP_TREE_HPP_INCLUDED
...
public:
    explicit LazyTopTree(int n = MAX_SIZE): _n(n), state(nullptr){
    ...
    LazyTopTree(const LazyTopTree&) = delete;
    LazyTopTree& operator=(const LazyTopTree&) = delete;
    LazyTopTree(LazyTopTree&&) = default;
    LazyTopTree& operator=(LazyTopTree&&) = default;
...
#endif  // CPPLIB_SRC_STRUCTURE_TREE_DYNAMIC_FOREST_LAZY_TOP_TREE_HPP_INCLUDED
