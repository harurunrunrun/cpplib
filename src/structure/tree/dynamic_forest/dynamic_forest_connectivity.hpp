#ifndef CPPLIB_SRC_STRUCTURE_TREE_DYNAMIC_FOREST_DYNAMIC_FOREST_CONNECTIVITY_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_TREE_DYNAMIC_FOREST_DYNAMIC_FOREST_CONNECTIVITY_HPP_INCLUDED
