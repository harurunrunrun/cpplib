#ifndef CPPLIB_SRC_STRUCTURE_BIT_BITSET_XOR_SHIFT_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_BIT_BITSET_XOR_SHIFT_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_BIT_BITSET_XOR_SHIFT_HPP_INCLUDED
