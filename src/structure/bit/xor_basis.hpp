#ifndef CPPLIB_SRC_STRUCTURE_BIT_XOR_BASIS_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_BIT_XOR_BASIS_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_BIT_XOR_BASIS_HPP_INCLUDED
