#ifndef CPPLIB_SRC_STRUCTURE_PERSISTENCE_PERSISTENT_QUEUE_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_PERSISTENCE_PERSISTENT_QUEUE_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_PERSISTENCE_PERSISTENT_QUEUE_HPP_INCLUDED
