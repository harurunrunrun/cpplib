#ifndef CPPLIB_SRC_STRUCTURE_WAVELET_MATRIX_PERSISTENT_PERSISTENT_FUNCTIONAL_WAVELET_MATRIX_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_WAVELET_MATRIX_PERSISTENT_PERSISTENT_FUNCTIONAL_WAVELET_MATRIX_HPP_INCLUDED
...
struct PersistentFunctionalWaveletMatrix :
    PersistentWeightedWaveletMatrix<T, Sum, MAX_SIZE, MAX_VERSION, BIT_WIDTH>{
    static_assert(std::is_constructible_v<Sum, T> || std::is_convertible_v<T, Sum>);
    using Base = PersistentWeightedWaveletMatrix<T, Sum, MAX_SIZE, MAX_VERSION, BIT_WIDTH>;
...
#endif  // CPPLIB_SRC_STRUCTURE_WAVELET_MATRIX_PERSISTENT_PERSISTENT_FUNCTIONAL_WAVELET_MATRIX_HPP_INCLUDED
