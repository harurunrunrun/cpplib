#ifndef CPPLIB_SRC_STRUCTURE_WAVELET_MATRIX_STATIC_RECTANGLE_SUM_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_WAVELET_MATRIX_STATIC_RECTANGLE_SUM_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_WAVELET_MATRIX_STATIC_RECTANGLE_SUM_HPP_INCLUDED
