#ifndef CPPLIB_SRC_STRUCTURE_WAVELET_MATRIX_STATIC_COMPRESSED_WAVELET_MATRIX_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_WAVELET_MATRIX_STATIC_COMPRESSED_WAVELET_MATRIX_HPP_INCLUDED
...
public:
    explicit CompressedWaveletMatrix(const std::vector<T>& sequence):
    ...
    explicit CompressedWaveletMatrix(const std::array<T, N>& sequence):
        CompressedWaveletMatrix(std::vector<T>(sequence.begin(), sequence.end())){
        static_assert(N <= static_cast<std::size_t>(MAX_SIZE));
    }

    CompressedWaveletMatrix(const CompressedWaveletMatrix&) = delete;
    CompressedWaveletMatrix& operator=(const CompressedWaveletMatrix&) = delete;
    CompressedWaveletMatrix(CompressedWaveletMatrix&&) = default;
    CompressedWaveletMatrix& operator=(CompressedWaveletMatrix&&) = default;
...
#endif  // CPPLIB_SRC_STRUCTURE_WAVELET_MATRIX_STATIC_COMPRESSED_WAVELET_MATRIX_HPP_INCLUDED
