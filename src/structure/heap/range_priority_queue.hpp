#ifndef CPPLIB_SRC_STRUCTURE_HEAP_RANGE_PRIORITY_QUEUE_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_HEAP_RANGE_PRIORITY_QUEUE_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_HEAP_RANGE_PRIORITY_QUEUE_HPP_INCLUDED
