#ifndef CPPLIB_SRC_STRUCTURE_HEAP_KINETIC_TOURNAMENT_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_HEAP_KINETIC_TOURNAMENT_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_HEAP_KINETIC_TOURNAMENT_HPP_INCLUDED
