#ifndef CPPLIB_SRC_STRUCTURE_FENWICK_TREE_RANGE_ADD_POINT_GET_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_FENWICK_TREE_RANGE_ADD_POINT_GET_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_FENWICK_TREE_RANGE_ADD_POINT_GET_HPP_INCLUDED
