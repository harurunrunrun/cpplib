#ifndef CPPLIB_SRC_STRUCTURE_ORDERED_SET_INTEGER_SET_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_ORDERED_SET_INTEGER_SET_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_ORDERED_SET_INTEGER_SET_HPP_INCLUDED
