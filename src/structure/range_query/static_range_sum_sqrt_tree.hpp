#ifndef CPPLIB_SRC_STRUCTURE_RANGE_QUERY_STATIC_RANGE_SUM_SQRT_TREE_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_RANGE_QUERY_STATIC_RANGE_SUM_SQRT_TREE_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_RANGE_QUERY_STATIC_RANGE_SUM_SQRT_TREE_HPP_INCLUDED
