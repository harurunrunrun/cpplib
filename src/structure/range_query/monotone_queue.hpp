#ifndef CPPLIB_SRC_STRUCTURE_RANGE_QUERY_MONOTONE_QUEUE_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_RANGE_QUERY_MONOTONE_QUEUE_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_RANGE_QUERY_MONOTONE_QUEUE_HPP_INCLUDED
