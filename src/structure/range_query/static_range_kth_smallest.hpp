#ifndef CPPLIB_SRC_STRUCTURE_RANGE_QUERY_STATIC_RANGE_KTH_SMALLEST_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_RANGE_QUERY_STATIC_RANGE_KTH_SMALLEST_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_RANGE_QUERY_STATIC_RANGE_KTH_SMALLEST_HPP_INCLUDED
