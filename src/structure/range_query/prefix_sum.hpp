#ifndef CPPLIB_SRC_STRUCTURE_RANGE_QUERY_PREFIX_SUM_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_RANGE_QUERY_PREFIX_SUM_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_RANGE_QUERY_PREFIX_SUM_HPP_INCLUDED
