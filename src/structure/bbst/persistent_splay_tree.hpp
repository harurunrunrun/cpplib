#ifndef CPPLIB_SRC_STRUCTURE_BBST_PERSISTENT_SPLAY_TREE_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_BBST_PERSISTENT_SPLAY_TREE_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_BBST_PERSISTENT_SPLAY_TREE_HPP_INCLUDED
