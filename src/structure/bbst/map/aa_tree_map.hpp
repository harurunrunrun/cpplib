#ifndef CPPLIB_SRC_STRUCTURE_BBST_MAP_AA_TREE_MAP_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_BBST_MAP_AA_TREE_MAP_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_BBST_MAP_AA_TREE_MAP_HPP_INCLUDED
