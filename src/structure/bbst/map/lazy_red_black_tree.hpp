#ifndef CPPLIB_SRC_STRUCTURE_BBST_MAP_LAZY_RED_BLACK_TREE_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_BBST_MAP_LAZY_RED_BLACK_TREE_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_BBST_MAP_LAZY_RED_BLACK_TREE_HPP_INCLUDED
