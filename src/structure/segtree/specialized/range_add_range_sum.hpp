#ifndef CPPLIB_SRC_STRUCTURE_SEGTREE_SPECIALIZED_RANGE_ADD_RANGE_SUM_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_SEGTREE_SPECIALIZED_RANGE_ADD_RANGE_SUM_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_SEGTREE_SPECIALIZED_RANGE_ADD_RANGE_SUM_HPP_INCLUDED
