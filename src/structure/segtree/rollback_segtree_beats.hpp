#ifndef CPPLIB_SRC_STRUCTURE_SEGTREE_ROLLBACK_SEGTREE_BEATS_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_SEGTREE_ROLLBACK_SEGTREE_BEATS_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_SEGTREE_ROLLBACK_SEGTREE_BEATS_HPP_INCLUDED
