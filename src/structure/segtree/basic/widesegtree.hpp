#ifndef CPPLIB_SRC_STRUCTURE_SEGTREE_BASIC_WIDESEGTREE_HPP_INCLUDED
#define CPPLIB_SRC_STRUCTURE_SEGTREE_BASIC_WIDESEGTREE_HPP_INCLUDED
...
#endif  // CPPLIB_SRC_STRUCTURE_SEGTREE_BASIC_WIDESEGTREE_HPP_INCLUDED
