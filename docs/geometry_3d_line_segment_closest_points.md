---
title: Closest Points between 3D Line and Segment (三次元直線と線分の最近点対)
documentation_of: ../src/algorithm/geometry/3d/point_collection/line_segment_closest_points.hpp
---
...
最近点対が複数ある場合はそのうち1組を返す。線分は退化してもよい。退化直線・非有限入力には
