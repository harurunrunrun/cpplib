...
documentation_of: ../../../../../../src/algorithm/geometry/3d/aggregate/all/ray_plane_closest_points.hpp
---
...
最近点対が複数ある場合はそのうち1組を返す。退化半直線・零法線平面・非有限入力には `std::invalid_argument` を送出する。
