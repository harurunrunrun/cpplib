...
documentation_of: ../../../../../../src/algorithm/geometry/3d/point_set/ray_ray/ray_ray_closest_points.hpp
---

## API

- `closest_points(first, second)`: 2つの `Ray3` 上の最近点を引数と同じ順のpairで返す。異種型では逆順overloadも提供する。
