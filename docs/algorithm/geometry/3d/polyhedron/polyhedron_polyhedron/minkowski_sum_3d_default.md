---
title: Minkowski Sum 3D with Default Seed (固定seedによる三次元Minkowski和)
documentation_of: ../../../../../../src/algorithm/geometry/3d/polyhedron/polyhedron_polyhedron/minkowski_sum_3d_default.hpp
---

全頂点対の和を候補とし、固定seedの三次元凸包としてMinkowski和を構築する。

## API

- `minkowski_sum_3d(first, second)`: $\{a+b\mid a\in A,b\in B\}$ の
