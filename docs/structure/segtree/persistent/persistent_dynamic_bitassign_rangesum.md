---
title: Persistent Dynamic BitAssign RangeSum (完全永続動的ビット代入・区間和)
documentation_of: ../../../../src/structure/segtree/persistent/persistent_dynamic_bitassign_rangesum.hpp
---

巨大なbit列に対する完全永続な区間代入・区間和。暗黙segment treeを使う。
...
このheaderは `PersistentDynamicBitAssignRangeSum` を
`PersistentBitAssignRangeSum` の別名として公開する。
