...
documentation_of: ../../../../src/structure/segtree/partially_persistent/partially_persistent_segtree.hpp
---
...
- 過去versionの `get`: $O(\log \mathrm{MAX\_UPDATE})$
- 過去versionの `prod`: $O(\log \mathrm{MAX\_SIZE}\log \mathrm{MAX\_UPDATE})$
