---
title: Partially Persistent Dynamic BitAssign RangeSum (部分永続動的ビット代入・区間和)
documentation_of: ../../../../src/structure/segtree/partially_persistent/partially_persistent_dynamic_bitassign_rangesum.hpp
---
...
このheaderは `PartiallyPersistentDynamicBitAssignRangeSum` を非`Dynamic`名の型の別名として公開する。
