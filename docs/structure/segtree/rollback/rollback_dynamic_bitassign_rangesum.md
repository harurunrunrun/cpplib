...
documentation_of: ../../../../src/structure/segtree/rollback/rollback_dynamic_bitassign_rangesum.hpp
---

巨大bit列に対するrollback可能な区間代入・区間和。
...
このheaderは `RollbackDynamicBitAssignRangeSum` を非`Dynamic`名の型の別名として公開する。
