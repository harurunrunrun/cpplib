---
title: Partially Persistent Fully Indexable Dictionary (部分永続完備辞書)
documentation_of: ../../../../src/structure/wavelet_matrix/partially_persistent/partially_persistent_fully_indexable_dictionary.hpp
---
