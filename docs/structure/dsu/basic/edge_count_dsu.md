...
documentation_of: ../../../../src/structure/dsu/basic/edge_count_dsu.hpp
---
...
- `leader`、`same`、`component_size`、`edges`、`excess_edges`、`is_tree`、`is_unicyclic`、`add_edge`: 再帰する代表探索のstackを含めworst-case $O(\log N)$
