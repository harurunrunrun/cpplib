    ...
    return geometry3d_api_test_main([](
        ...
        for(std::size_t iteration = 0; iteration < direct_rounds; ++iteration){
            ...
            const ConvexPolyhedron3 expected =
                minkowski_difference_3d_with_seed(first, second, random());
            const ConvexPolyhedron3 direct =
                minkowski_difference_3d_direct(first, second);
        ...
        const ConvexPolyhedron3 performance = minkowski_difference_3d_direct(
        ...
        try{
            static_cast<void>(minkowski_difference_3d_direct(tetra, tetra));
