...
#include <utility>
#include <vector>
#include "../../src/structure/tree/dynamic_forest/lazy_top_tree.hpp"
...
int main(){
    ...
    if(std::cin >> input_n >> input_m >> q){
        ...
        LazyTopTree<range_add_sum, 128> tree(input);
    ...
    LazyTopTree<range_add_sum, 80> tree(value);
