...
#include "../../src/algorithm/geometry/3d/point_set/line_segment/line_segment_closest_points_line_segment.hpp"
#include "../../src/algorithm/geometry/3d/point_set/segment_line/line_segment_closest_points_segment_line.hpp"
#include "../../src/algorithm/geometry/3d/aggregate/all/line_segment_closest_points.hpp"
...
int main(){
    return geometry3d_api_test_main([](std::mt19937_64&, std::size_t){
        ...
        const auto reversed = closest_points(segment, line);
        if(!geometry3d_api_close(points.first, {})
            || !geometry3d_api_close(points.second, segment.a)
            || !geometry3d_api_close(reversed.first, segment.a)
