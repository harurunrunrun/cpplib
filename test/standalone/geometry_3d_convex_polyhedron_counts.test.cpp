...
#include "../../src/algorithm/geometry/3d/type/definition/convex_polyhedron_counts3.hpp"
...
int main(){
    return geometry3d_api_test_main([](std::mt19937_64&, std::size_t){
        const ConvexPolyhedronCounts3 counts =
            convex_polyhedron_counts(geometry3d_test_cube());
