...
#include "../../src/algorithm/geometry/2d/scalar/point_set_point_set/convex_polygon_minimum_distance.hpp"
...
int main(){
    ...
    while(queries-- > 0){
        ...
        geometry_test_print_real(convex_polygon_minimum_distance(
