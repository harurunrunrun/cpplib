...
def main() -> None:
    ...
    cases: list[Case] = [
        ...
        (4, complete_four, 4, 3, 20, 7, True, None, True),
        (4, complete_four, 3, 4, 120, 7, True, None, False),
        (6, cycle(6), 2, 5, 300, 7, True, None, True),
        (5, cycle(5), 2, 6, 300, 7, False, None, False),
        (3, cycle(3), 3, 7, 20, 1, True, None, True),
        (8, complete_bipartite(4, 4), 2, 8, 300, 5, True, None, True),
        (3, [(0, 1), (1, 0), (0, 1), (1, 2)], 2, 9, 100, 3, True, None, True),
        (4, [(0, 1), (1, 2), (2, 3)], 2, 10, 100, 4, True, [2, 0, 2, 1], True),
        (3, [(0, 1), (1, 2)], 2, 11, 0, 4, True, [2, 0, 1], False),
    ]
    for _ in range(24):
        ...
        if optimum > 1 and rng.randrange(3) == 0:
            target = optimum - 1
        cases.append((
            vertex_count, edges, target, rng.getrandbits(64), 800, rng.randrange(1, 9),
